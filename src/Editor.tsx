...
import { useMonacoEditor } from './lib/mylang-language-service';
...
export const Editor: FC<Props> = (props: Props) => {
  const editorProps = useMonacoEditor({ initialValue: getInitialValue() });

  return <MonacoEditor width='800' height='300' {...editorProps} />;
};
